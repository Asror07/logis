...
import { typeColors, previewReplacements } from '../data';
      ...
      <CardContent className="space-y-6">
        ...
        <div>
          ...
          <div className={cn(
            ...
            isEditing ? "border-primary bg-secondary" : "border-border bg-secondary/30"
          )}>
            {isEditing ? (
              <textarea
        ...
        <div>
          ...
          <div className="flex gap-3">
            <input
              type="text"
              placeholder={template.channel === 'sms' ? '+1 555-0123' : 'test@example.com'}
